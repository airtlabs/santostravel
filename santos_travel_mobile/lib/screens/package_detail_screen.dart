...
class _PackageDetailScreenState extends ConsumerState<PackageDetailScreen> {
                            ...
                            children: [
                              ...
                              SizedBox(
                                ...
                                child: ElevatedButton(
                                  onPressed: _isBooking ? null : () => _handleBookNow(package),
                                  child: _isBooking
  ...
  Future<void> _handleBookNow(TravelPackage package) async {
    ...
    if (!AuthService.isLoggedIn) {
      final result = await showDialog<bool>(
        ...
        builder: (context) => AlertDialog(
          ...
          content: const Text('Please sign in to book this package.'),
          actions: [
            TextButton(
      ...
      if (result == true) {
        ...
        // After returning from sign in, check again
    ...
    // If signed in, proceed with booking
    await _bookPackage(package);
  }
